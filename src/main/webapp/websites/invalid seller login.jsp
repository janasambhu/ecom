        ...
        <div class="row">
            ...
            <div class="col-2">
                <div class="form-container">
                    ...
                    <form action="<%=request.getContextPath()%>/SellersLoginDataCollection" id="LoginForm" method="post">
                        <label>Invalid mobile number and password</label>
                       
                        <input type="text" name="mobile" placeholder="Mobile Number">
                        <label id="span7"></label>
                   
                        <input type="password" name="pass" placeholder="Password">
                       <label id="span8"></label>
