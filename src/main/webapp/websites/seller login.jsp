                ...
                <ul id="MenuItems">
                    ...
                    <li>
                        <select onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                            ...
                            <option value="<%=request.getContextPath()%>/websites/customer registration.html">Customer</option>
                            <option value="<%=request.getContextPath()%>/websites/seller registration.html">Seller</option>
                        </select>
                    </li>
                </ul>
            </nav>
        ...
        <div class="row">
            ...
            <div class="col-2">
                <div class="form-container">
                    ...
                    <form action="<%=request.getContextPath()%>/SellersLoginDataCollection" name="f1" onsubmit="return matchpass()" id="LoginForm" method="post">
